...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $create_attendance_query = "INSERT INTO attendances (section_id, month, year, ci, total_classes) VALUES ('$section_id', '$month', '$year', '$ci', '$total_classes')";
    $create_attendance_result = mysqli_query($conn, $create_attendance_query);
    if ($create_attendance_result) {
        $attendance_id = $conn->insert_id;
        $attendance_students_query = '';
        for ($i = 0; $i < count($student_list); $i++) {
            $student_id = $student_list[$i];
            $days = $days_list[$i];
            $attendance_students_query .= "INSERT INTO attendance_students (attendance_id, student_id, days) VALUES ('$attendance_id', '$student_id', '$days');";
        }
        $attendance_students_result = mysqli_multi_query($conn, $attendance_students_query);
        if ($attendance_students_result) {
            $message = 'Attendance has been successfully saved!';
        } else {
            $error = 'Unable to save the student attendance records!';
        }
    } else {
        $error = 'Unable to save the attendance!';
    }
}
...
<head>
    ...
    <title>Create Attendance &mdash; EduRV</title>
                ...
                <section class="section">
                    <div class="section-header">
                        <div class="section-header-back">
                            <a href="attendances.php" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                        </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Total Classes</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input class="form-control" name="total_classes" type="number" required autofocus>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                echo '
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-sm-12 col-md-7">
                                                            ...
                                                            <input class="form-control" name="days[]" type="number" required autofocus>
                                                        </div>
                                                    </div>
                                                ';
                                            }
