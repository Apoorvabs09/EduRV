                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="create-mark.php" method="GET" class="needs-validation" onsubmit="get()">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                for ($i = 0; $i < count($marks); $i++) {
                                                    ...
                                                    echo '<td><div class="buttons"><a href="remove-mark.php?id=' . $mark['id'] . '" class="btn btn-icon btn-danger"><i class="fas fa-trash"></i></a></div></td>';
                                                    echo '</tr>';
                                                }
                                                ?>
                                            </table>
                                            <?php if (count($marks) == 0) echo '<p class="text-center">No marks found</p>'; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
