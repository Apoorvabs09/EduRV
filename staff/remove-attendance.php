...
$attendance;
$attendance_query = "SELECT * FROM attendances WHERE id = '$attendance_id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $remove_attendance_query = "DELETE FROM attendances WHERE id = '$attendance_id'";
    $remove_attendance_result = mysqli_query($conn, $remove_attendance_query);
    if ($remove_attendance_result) {
        $message = 'Attendance has been successfully removed!';
    } else {
        $error = 'Unable to remove the attendance!';
    }
}
...
<head>
    ...
    <title>Remove Attendance &mdash; EduRV</title>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4>CIE ' . $attendance['ci'] . ' - ' . $attendance['month'] . '/' . $attendance['year'] .  '</h4>
                                            </div>
                                            <div class="card-body">
                                                <p>Are you sure you want to remove the attendance?</p>
