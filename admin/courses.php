...
<head>
    ...
    <title>Courses &mdash; EduRV</title>
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a class="nav-link" href="courses.php"><i class="fas fa-table"></i> <span>Courses</span></a></li>
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-button">
                            <a href="create-course.php" class="btn btn-primary">Add New</a>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                for ($i = 0; $i < count($courses); $i++) {
                                                    ...
                                                    echo '<td><div class="buttons"><a href="update-course.php?id=' . $course['id'] . '" class="btn btn-icon btn-primary"><i class="fas fa-edit"></i></a><a href="remove-course.php?id=' . $course['id'] . '" class="btn btn-icon btn-danger"><i class="fas fa-trash"></i></a></div></td>';
                                                    echo '</tr>';
                                                }
                                                ?>
                                            </table>
                                            <?php if (count($courses) == 0) echo '<p class="text-center">No courses found</p>'; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
