...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = file_get_contents('../student/download-report.html');
...
$students = [];
$students_query = "SELECT students.id, students.usn, students.name FROM students";
                                    ...
                                    <div class="card-body">
                                        <form target="_blank" action="" method="POST" class="needs-validation">
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Student</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <select class="form-control" name="student_id" required autofocus>
                                                        <option selected disabled>Choose Student</option>
                                                        <?php
                                                        foreach ($students as $student) {
                                                            echo '<option value="' . $student['id'] . '">' . $student['usn'] . ' - ' . $student['name'] . '</option>';
                                                        }
                                                        ?>
                                                    </select>
                                                </div>
