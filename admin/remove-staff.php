...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $remove_staff_query = "DELETE FROM staffs WHERE id = '$staff_id'";
    $remove_staff_result = mysqli_query($conn, $remove_staff_query);
    if ($remove_staff_result) {
        $message = 'Staff has been successfully removed!';
    } else {
        $error = 'Unable to remove the staff!';
    }
}
...
<head>
    ...
    <title>Remove Staff &mdash; EduRV</title>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="" method="POST" onsubmit="remove()">
                                                    <div class="buttons">
                                                        <a href="staffs.php"><button type="button" class="btn btn-secondary">Cancel</button></a>
