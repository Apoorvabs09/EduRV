...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $remove_course_query = "DELETE FROM courses WHERE id = '$course_id'";
    $remove_course_result = mysqli_query($conn, $remove_course_query);
    if ($remove_course_result) {
        $message = 'Course has been successfully removed!';
    } else {
        $error = 'Unable to remove the course!';
    }
}
...
<head>
    ...
    <title>Remove Course &mdash; EduRV</title>
