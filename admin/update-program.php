...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $name = $_POST["name"];
    $update_program_query = "UPDATE programs SET name = '$name' WHERE id = '$program_id'";
    $update_program_result = mysqli_query($conn, $update_program_query);
    if ($update_program_result) {
...
<head>
    ...
    <title>Update Program &mdash; EduRV</title>
                                        ...
                                        <form action="" method="POST" class="needs-validation" onsubmit="update()">
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input class="form-control" name="name" value="<?php echo $program['name'] ?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
