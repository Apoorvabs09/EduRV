...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $create_course_query = "INSERT INTO courses (code, name, semester) VALUES ('$code', '$name', '$semester')";
    $create_course_result = mysqli_query($conn, $create_course_query);
...
<head>
    ...
    <title>Create Course &mdash; EduRV</title>
                                        ...
                                        <form action="" method="POST" class="needs-validation" onsubmit="create()">
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input class="form-control" name="code" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input class="form-control" name="semester" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
