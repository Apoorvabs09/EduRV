...
<head>
    ...
    <title>Programs &mdash; EduRV</title>
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a class="nav-link" href="programs.php"><i class="fas fa-table"></i> <span>Programs</span></a></li>
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-button">
                            <a href="create-program.php" class="btn btn-primary">Add New</a>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                for ($i = 0; $i < count($programs); $i++) {
                                                    ...
                                                    echo '<td><div class="buttons"><a href="update-program.php?id=' . $program['id'] . '" class="btn btn-icon btn-primary"><i class="fas fa-edit"></i></a><a href="remove-program.php?id=' . $program['id'] . '" class="btn btn-icon btn-danger"><i class="fas fa-trash"></i></a></div></td>';
                                                    echo '</tr>';
                                                }
                                                ?>
                                            </table>
                                            <?php if (count($programs) == 0) echo '<p class="text-center">No programs found</p>'; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
