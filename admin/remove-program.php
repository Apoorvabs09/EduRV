...
if ($program_result && mysqli_num_rows($program_result) == 1) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $remove_program_query = "DELETE FROM programs WHERE id = '$program_id'";
    $remove_program_result = mysqli_query($conn, $remove_program_query);
    if ($remove_program_result) {
        $message = 'Program has been successfully removed!';
    } else {
        $error = 'Unable to remove the program!';
    }
}
...
<head>
    ...
    <title>Remove Program &mdash; EduRV</title>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="" method="POST" onsubmit="remove()">
                                                    <div class="buttons">
                                                        <a href="programs.php"><button type="button" class="btn btn-secondary">Cancel</button></a>
