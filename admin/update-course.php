...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_course_query = "UPDATE courses SET code = '$code', name = '$name', semester = '$semester' WHERE id = '$course_id'";
...
<head>
    ...
    <title>Update Course &mdash; EduRV</title>
                ...
                <section class="section">
                    <div class="section-header">
                        <div class="section-header-back">
                            <a href="courses.php" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                        </div>
                        <h1>Update Course</h1>
                    </div>
                    <?php
                                        ...
                                        <form action="" method="POST" class="needs-validation" onsubmit="update()">
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input class="form-control" name="code" value="<?php echo $course['code'] ?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Course Name</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input class="form-control" name="name" value="<?php echo $course['name'] ?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Semester</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input class="form-control" name="semester" value="<?php echo $course['semester'] ?>" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
